...
export default function GradientText({
  ...
  return (
    <motion.span
      className={`relative inline-flex max-w-fit items-center justify-center overflow-hidden rounded-[1.25rem] transition-shadow duration-500 ${showBorder ? 'px-2 py-1' : ''} ${className}`}
